...
const preloadedState = localStorage.getItem(addKeyLocalStorage(globalKeys.PRELOADED_STATE))
  ? JSON.parse(localStorage.getItem(addKeyLocalStorage(globalKeys.PRELOADED_STATE)) || '{}')
  : {}
